...
class ListRoomChatTentor extends StatefulWidget {
  @override
  _ListRoomChatTentorState createState() => _ListRoomChatTentorState();
}

class _ListRoomChatTentorState extends State<ListRoomChatTentor> {
  List room = new List();
  bool load = true;
  String nama = '';
  void getList() async {
    ...
    if (load) {
      ...
      return ListView.builder(
          ...
          itemBuilder: (BuildContext context, int i) {
            ...
            return InkWell(
              onTap: () {
                Navigator.pushNamed(context, Routes.DETAIL_CHAT_TENTOR,
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () {
        Navigator.pushNamed(context, Routes.HOME_TENTOR, arguments: '0');
      },
      child: Scaffold(
        appBar: AppBar(
